...
## 🚀 Perfil Profesional
Estudiante avanzado de **Programación Universitaria (UTN)** con sólida formación como **Desarrollador Full Stack**. Poseo experiencia en la construcción de soluciones web funcionales y escalables, aplicando tecnologías modernas en entornos **Frontend** y **Backend**.

Mi enfoque está en el **aprendizaje continuo**, la aplicación de buenas prácticas y la colaboración efectiva en equipos ágiles (SCRUM) para entregar productos de alta calidad.

---

## 🛠️ Stack Tecnológico
Aquí se encuentran las principales herramientas y lenguajes que utilizo en mis desarrollos:
